import { useDeleteBookMutation } from '@rtk/features/api/apiSlice';
    ...
    <div className="book-card">
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div className="flex items-center justify-between">
          {featured ? <span className="lws-badge">Featured</span> : <div></div>}
          <div className="text-gray-500 space-x-2">
            <Link to={`/edit-book/${id}`} className="lws-edit inline-block">
            ...
            <button className="lws-deleteBook" onClick={handleDeleteBook}>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
